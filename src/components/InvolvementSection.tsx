  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-14">
        {/* How to get involved */}
        <div className="relative w-full max-w-xl rounded-[2.5rem] rounded-bl-none bg-slate-300 px-7 py-8 text-slate-950 sm:px-10 sm:py-10 lg:ml-8">
          <h1
            id="involvement-heading"
            className="text-3xl font-bold leading-[1.05] tracking-tight text-black sm:text-3xl"
          >
            How do I get involved?
          </h1>

          <p className="mt-5 max-w-xl text-base leading-relaxed sm:text-l">
        ...
        {/* Discord information */}
        <div className="relative w-full max-w-md self-end rounded-[2.5rem] rounded-br-none bg-slate-300 px-6 py-8 text-slate-950 sm:px-10 sm:py-10 lg:mr-8">
          <div className="flex items-start justify-between gap-6">
            <div>
              <h2 className="text-3xl font-bold leading-[1.05] tracking-tight text-black sm:text-3xl">
                Join our Discord!
              </h2>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-5 block break-all text-base underline underline-offset-4 hover:text-slate-700 sm:text-l"
              >
